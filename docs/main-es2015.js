...
ProductListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProductListComponent, selectors: [["app-product-list"]], decls: 8, vars: 3, consts: [[3, "value", "valueChange"], [3, "value", 4, "ngFor", "ngForOf"], [4, "ngFor", "ngForOf"], [3, "value"], [4, "ngIf"], ["target", "_blank", 3, "title", "href"], [2, "display", "flex"], [2, "width", "40%", "margin-right", "20px", 3, "src"]], template: function ProductListComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("valueChange", function ProductListComponent_Template_mat_select_valueChange_5_listener($event) { return ctx.selected = $event; });
...
module.exports = __webpack_require__(/*! /home/jpozorio/lives-quarentena-brasil/src/main.ts */"./src/main.ts");
